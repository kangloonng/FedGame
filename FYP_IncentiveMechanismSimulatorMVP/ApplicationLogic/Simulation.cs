...
namespace FYP_IncentiveMechanismSimulatorMVP.ApplicationLogic
{
    public sealed class Simulation
    {
        ...
        public void FixedSettings()
        {
            ...
            string[] fixedParamsNum = textCategory[1].Split(new[] { Environment.NewLine }, StringSplitOptions.None);
            string[] playersParam = textCategory[2].Split(new[] { Environment.NewLine }, StringSplitOptions.None);
            string[] federationParam = textCategory[3].Split(new[] { Environment.NewLine }, StringSplitOptions.None);
